...
if($s3->getObject("tempsecupload", $filename2,'temp.c')){
	
	$result1 = $s3->getObject("tempsecupload", $filename2,'temp.c');

	$homepage = file_get_contents('temp.c');
	
	$absolute_path = realpath("temp.java");
	echo $absolute_path;
	
	exec("flawfinder $absolute_path/temp.c", $out, $val);
